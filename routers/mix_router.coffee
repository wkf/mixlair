module.exports = (app) ->
  class MixRouter extends app.Router
    ...
    @post '/user/:user/mix/:mix', @routeTo(MixController, 'createMix')
    ...
    @post '/user/:user/mix/:mix/track/:track', @routeTo(MixController, 'createTrack')
    ...
    @post '/user/:user/mix/:mix/track/:track/region/:region', @routeTo(MixController, 'createRegion')
